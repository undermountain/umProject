    ...
    <div class="collapse navbar-collapse" id="nav_target">
      <ul class="nav navbar-nav">
        <!-- リンクのみ -->
          ...
          <li><a href="/um/hpsiter/home/index">Infomation</a></li>
      </ul>
  <!-- 右寄せになる部分 ================ -->
...
<nav class="navbar navbar-inverse">
  ...
  <!-- 中央のナビゲーション部分 ================ -->
    <div class="collapse navbar-collapse" id="nav_target">
      <ul class="nav navbar-nav">
        <!-- リンクのみ -->
		<li class="<%=Util.isActive(request, "/dbsiter/home/index")%>">
   			<a class="navbar-brand" href="/um/dbsiter/home/index" style="font-weight:bold;">DBSiter</a>
   		</li>
